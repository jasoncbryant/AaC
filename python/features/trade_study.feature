Feature:  Trade study document model with requirements example
    ...
    Scenario Outline:  Ensure all requirements are parsed and loaded into context
        Given I have the "./trade_study/doc/cookie_trade_study.aac" model
        When I load the "./trade_study/doc/cookie_trade_study.aac" model
    ...
    Scenario:  Check the echo model
        Given I have the "./trade_study/doc/cookie_trade_study.aac" model
        When I check the "./trade_study/doc/cookie_trade_study.aac" model
